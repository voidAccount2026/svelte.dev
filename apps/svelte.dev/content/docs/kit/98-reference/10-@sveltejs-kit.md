...
[`error`](/docs/kit/errors#Expected-errors) helper), unexpected errors
...
The `kind` property discriminates between _expected_ errors (thrown with the [`error`](/docs/kit/errors#Expected-errors) helper),
